...
system = sb.selectbox("System", ["Rack and Pinion"],index=None)#, "Wheel and Pinion"])
...
if system == "Rack and Pinion":
    ...
    if rack_material == "Structural Alloy Steel":
        ...
        if rack_treat == "Without Case Hardening" or rack_treat == "Induction Hardened":
    ...
    if rack_material == "Structural Carbon Steel":
        ...
        elif rack_treat == "Nitrided" or rack_treat == "Soft Nitrided":
    ...
    elif rack_material == "Gray Cast Iron":
        rack_material_specific = None
...
#Without Case Hardening Racks
    ...
    if rack_treat == "Without Case Hardening":
        if rack_material == "Structural Carbon Steel":
            if pre_treatment == "Normalised":
                ...
                if rack_material_specific == "S53C" or rack_material_specific == "S58C":
                    hardness_arr = np.linspace(180,230,6)
                ...
                if rack_material_specific == None:
                    hardness_arr = None
                ...
                elif rack_material_specific == None:
                    hardness_arr = None
        ...
        if rack_material == "Structural Alloy Steel":
            ...
            elif rack_material_specific == "SNC836" or rack_material_specific == "SCM435":
            ...
            elif rack_material_specific == "SCM440":
            ...
            elif rack_material_specific == "SNCM439":
    ...
    if rack_treat == "Induction Hardened":     
        if rack_material == "Structural Carbon Steel":
            if pre_treatment == "Normalised":
                ...
                elif rack_material_specific == "S43C":
    ...
    if rack_treat == "Carburised":
        ...
        if rack_material == "Structural Carbon Steel":
            ...
            if core_hardness is None:
                sigma_F_rack = None
                sigma_H_rack = None
            elif core_hardness is not None:
            ...
            if rack_material_specific == "SCM415" or rack_material_specific == "SNC415":
    ...
    if rack_treat == "Soft Nitrided":
        ...
        if nitriding_time == 2:
            if rr_curvature == "Less than 10":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",100)
            elif rr_curvature == "10 to 20":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",90)
            elif rr_curvature == "More than 20":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",80)
            elif rr_curvature == None:
                sigma_H_rack = None
        elif nitriding_time == 4:
            if rr_curvature == "Less than 10":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",110)
            elif rr_curvature == "10 to 20":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",100)
            elif rr_curvature == "More than 20":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",90)
                ...
                sigma_H_rack = None
        elif nitriding_time == 6:
            if rr_curvature == "Less than 10":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",120)
            elif rr_curvature == "10 to 20":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",110)
            elif rr_curvature == "More than 20":
                sigma_H_rack = sb.metric("Allowable Surface Stress (MPa) $\\sigma_{Hlim}$",100)
